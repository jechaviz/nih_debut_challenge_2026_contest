...
- Undergraduate team requirement: [docs/undergraduate_team_required.md](docs/undergraduate_team_required.md)
...
- Evidence table: [docs/evidence_table.md](docs/evidence_table.md)
- Judge scorecard: [docs/judge_scorecard.md](docs/judge_scorecard.md)
- Design controls: [docs/design_controls.md](docs/design_controls.md)
- Traceability matrix: [docs/traceability_matrix.md](docs/traceability_matrix.md)
- Prod 100 audit: [docs/prod_100_completion_audit.md](docs/prod_100_completion_audit.md)
- Clinician validation protocol: [docs/clinician_validation_protocol.md](docs/clinician_validation_protocol.md)
- Final video shotlist: [docs/final_video_shotlist.md](docs/final_video_shotlist.md)
